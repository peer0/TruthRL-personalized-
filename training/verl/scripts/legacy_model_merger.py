...
python scripts/legacy_model_merger.py merge \
    --backend fsdp \
    --local_dir checkpoints/verl/crag_meta-llama/Llama-3.1-8B-Instruct_lr_1e-6_kl_loss_coef_0.001/global_step_100/actor \
    --target_dir /fsx_0/user/zhepei/projects/RAG-Online-DPO/Train/checkpoints/grpo/Llama-3.1-8B-Instruct_lr_1e-6_kl_loss_coef_0.001/global_step_100
```
