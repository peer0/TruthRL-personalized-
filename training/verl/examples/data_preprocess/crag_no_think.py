...
NO_THINK_FORMAT = "Please reason step by step and then provide the final answer. The final answer MUST be put in \\boxed{}. For example, \\boxed{I don't know}, \\boxed{invalid question}, \\boxed{3 times}, \\boxed{New York}, etc."
...
def make_map_fn(split, tokenizer, ook_ids, max_seq_length, max_new_tokens, extract_answer_box=False):
    ...
    def process_fn(example, idx):
        ...
        data = {
            ...
            "prompt": [{
                "role": "user",
                "content": format_prompt(example['prompt'][0]['content'].replace(BOX_FORMAT, NO_THINK_FORMAT), tokenizer, max_seq_length, max_new_tokens),
            }],
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/fsx_0/user/zhepei/projects/verl/data/crag_no_think')
