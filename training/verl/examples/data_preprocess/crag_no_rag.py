...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/fsx_0/user/zhepei/projects/verl/data/crag_no_rag')
    ...
    dataset_vanilla = datasets.load_dataset('weizhepei/CRAG-closed-book')
