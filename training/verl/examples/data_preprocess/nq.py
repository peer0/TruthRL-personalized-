...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/fsx_0/user/zhepei/projects/verl/data/nq_no_rag')
    parser.add_argument('--hdfs_dir', default=None)
    parser.add_argument('--template_type', type=str, default='base')

    args = parser.parse_args()

    data_source = 'searchR1_nq' # check verl/verl/utils/reward_score/__init__.py for predefined reward function
